...
export function Component() {
    ...
    useEffect(() => {
        ...
        const initApplication = async () => {
            ...
            const slides = [
                { title: "Ethereal Glow", description: "A soft, radiant light that illuminates the soul.", media: "https://images.unsplash.com/photo-1542281286-9e0a16bb7366?auto=format&fit=crop&q=80&w=2000&ixlib=rb-4.0.3" },
                { title: "Rose Mirage", description: "Lost in a desert of blooming dreams and endless horizons.", media: "https://images.unsplash.com/photo-1490750967868-58cb7506aed6?auto=format&fit=crop&q=80&w=2000&ixlib=rb-4.0.3" },
                { title: "Velvet Mystique", description: "Wrapped in the deep, luxurious embrace of the night.", media: "https://images.unsplash.com/photo-1550684848-fac1c5b4e853?auto=format&fit=crop&q=80&w=2000&ixlib=rb-4.0.3" },
                { title: "Golden Hour", description: "That fleeting moment when the world is dipped in gold.", media: "https://images.unsplash.com/photo-1477346611705-65d1883cee1e?auto=format&fit=crop&q=80&w=2000&ixlib=rb-4.0.3" },
                { title: "Midnight Dreams", description: "Where reality fades and imagination takes flight.", media: "https://images.unsplash.com/photo-1516339901601-2e1b62dc0c45?auto=format&fit=crop&q=80&w=2000&ixlib=rb-4.0.3" },
                { title: "Silver Light", description: "A cool, metallic shimmer reflecting the urban pulse.", media: "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&q=80&w=2000&ixlib=rb-4.0.3" }
            ];
    ...
    return (
        ...
        .slide-number { left: 40px; }
        .slide-total { right: 40px; }
        .slide-total::before { content: '/ '; opacity: 0.5; margin-right: 5px; }
